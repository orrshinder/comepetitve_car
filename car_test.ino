...
void loop() { //-------------------------------------------------------------------- State Machin
  ...
  switch(direction){
    ...
    case 1:       // -----------------------------------------------------------  START
         int count_time=0;
      while(count_time<3||(IRsensor_Front() < 1020)||(IRsensor_Left() < 1020)||(IRsensor_Right() < 1020)){ ///problme in millis()- not counting the current time 
        count_time++;
    ...
    case 4:     // ------------------------------------------------------------ Forward
      ...
      while((IRsensor_Front() < 1000)){ ////to check if the if is working after the while above it ??????
        Stop_Motor();
        delay(100);
        while((ultra_front() < 30)&&(ultra_right() < 30)){ //onject from the right
        Stop_Motor();
        delay(25);
        Serial.print("while  1");
        Serial.println();
        ...
        while((ultra_right() < 20)){ //onject from the right
        Stop_Motor();
        delay(25);
        Serial.print("while  1");
        Serial.println();
        ...
        while((ultra_front() < 30)&&(ultra_left() < 30)){//object from the left
         Stop_Motor();
           delay(25);
        Serial.print("while  2");
        Serial.println();
        ...
        while((ultra_left() < 20)){//object from the left
        Stop_Motor();
        delay(25);
        Serial.print("while  2");
        Serial.println();
        ...
        while((ultra_front() < 30)&&(IRsensor_Front() > 1000)||(ultra_left() < 30)&&(IRsensor_Left() > 1000)||(ultra_right() < 30)&&(IRsensor_Right() > 1000)){//// 30 sentimeter from the transmiter
           Stop_Motor();
           delay(250);
 ...
 ///////////////////////////////////////////////////////// serching
        Searching_Objects(); // 0 or other number will cheing the derection of the avoid object 
